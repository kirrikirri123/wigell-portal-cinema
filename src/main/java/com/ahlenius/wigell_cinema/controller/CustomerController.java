...
public class CustomerController {
    ...
    public ResponseEntity<AddressDto> addNewCostumerAddress(@PathVariable("customerId") Long id, @RequestBody CreateAddressDto dto) {
        return null;
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<CustomerDto> updateCustomer(@PathVariable("customerId") Long id, @RequestBody UpdateCustomerDto dto) {
        return null;
    }
